...
const Chapter2 = () => {
  return (
    <div className="chapter">
      <h1 className="chapter-title">2. Regulators, the Guardians of Capital Markets</h1>


      <h2>2.1 – What is the Stock Market?</h2>
      <p>
      ...
      <h2>2.2 – Market Participants and the Need to Regulate Them</h2>
      <p>
      ...
      <div className="navigation">
        <Link to="/chapter1" className="next-button">Previous</Link>
        &emsp;&emsp;&emsp;&emsp;
        <Link to="/chapter3" className="next-button">Next</Link>
      </div>
    </div>
  );
};
